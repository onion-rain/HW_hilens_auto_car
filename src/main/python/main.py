...
# root = "dataset/photo20200925_001145/"
...
#                 else:
#                     img_bgr = img_rgb
#                 img, labelName = draw_boxes(img_bgr, bboxes)  # 在图像上画框
#                 output_yuv = hilens.cvt_color(img, hilens.BGR2YUV_NV21)
#                 display.show(output_yuv)  # 显示到屏幕上
#                 # img = cv2.cvtColor(img, cv2.COLOR_RGB2BGR)
#                 cv2.imwrite("out/"+dir, img)
#             if log:
#                 time_frame = 1000 * (time.time() - time_start)
#                 hilens.info('----- time_frame = %.2fms -----' % time_frame)
